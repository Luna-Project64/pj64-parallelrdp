...
static void* gfx_ctx_w_vk_init(void* video_driver)
{
    ...
    {
        bool quit;
        create_vk_context(win32_get_window(), &quit);
    }
    return vk;
...
static void gfx_ctx_w_vk_input_driver(void* data,
    ...
    void** input, void** input_data)
{ }

static int gfx_ctx_w_vk_get_api(void* data) { return 0; }

static bool gfx_ctx_w_vk_bind_api(void* data,
    int api, unsigned major, unsigned minor)
{
    return true;
}
...
static bool win32_get_metrics(void* data, int type, float* value) { return false; }

static bool win32_suppress_screensaver(void* data, bool enable) { return false; }

static void win32_show_cursor(void* data, bool state) { return; }
