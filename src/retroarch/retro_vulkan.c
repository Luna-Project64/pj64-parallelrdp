    ...
    unsigned pitch, const char* msg)
{
    ...
    settings_t* settings = config_get_ptr();
    unsigned width = settings->uints.window_position_width;
    unsigned height = settings->uints.window_position_height;
