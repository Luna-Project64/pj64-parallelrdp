...
static bool vulkan_context_init_gpu(gfx_ctx_vulkan_data_t* vk)
{
    ...
    video_driver_set_gpu_api_devices(0, vk->gpu_list);
    ...
    enum vulkan_wsi_type type)
{
    ...
    app.pApplicationName = "rarch";
    app.applicationVersion = 0;
    app.pEngineName = "microarch";
    app.engineVersion = 0;
    ...
    unsigned swap_interval)
{
...
#ifdef _WIN32
    {
        ...
        if (vkCreateWin32SurfaceKHR(vk->context.instance,
            &surf_info, NULL, &vk->vk_surface) != VK_SUCCESS)
            return false;
    }
#endif
    ...
    bool destroy_surface)
{
    ...
    video_driver_set_gpu_api_devices(0, NULL);
    if (vk->gpu_list)
    {
        string_list_free(vk->gpu_list);
        vk->gpu_list = NULL;
